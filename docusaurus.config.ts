...
const config: Config = {
  ...
  baseUrl: '/2024-Everybot-Documentation/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'Robonauts-Everybot', // Usually your GitHub org/user name.
  projectName: '2024-Everybot-Documentation', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          { type: 'docSidebar', sidebarId: 'kitbotSidebar', label: "Everybot's 2024 Kitbot Resources", position: 'left' },
          //{
          //  type: 'localeDropdown',
          //  position: 'left',
          //},
